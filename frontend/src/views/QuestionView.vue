<template>
    <div class="container mt-3">
            ...
            <div v-else-if="showForm">
                <form @submit.prevent="onSubmit">
                    ...
                    <textarea v-model="newAnswerBody" class="form-control" placeholder="Share your Knowledge"
                        rows="10"></textarea>
                    <button type="submit" class="btn btn-outline-primary my-3">Submit your Answer</button>
                </form>
        ...
        <div class="my-4">
            ...
            <button v-show="next" @click="getQuestionAnswers" class="btn btn-sm btn-outline-primary">Load More</button>
        </div>
